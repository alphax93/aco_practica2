...
public class Ruta {
    ...
    public static int ruta(Grafo g, List<Vertice> result){
        ...
        temp.add(verticeAct);
        int pesoFin = aux(total,max,verticeAct,result, temp);
        
        
        return pesoFin;
    }
    
    private static int aux(int total, int max, Vertice verticeAct, List<Vertice> result, List<Vertice> temp){
        ...
        for (Arista arista : aristas) {
            ...
            if(suma<max){
                ...
                max=aux(suma, max, arista.getFin(),result,temp);
